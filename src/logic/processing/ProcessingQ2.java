...
public class ProcessingQ2 {
	...
	public static Dataset<SommDonne> parseCsvSommDonne(SparkSession spark ){
		// creo dataset con le colonne (area, data, fascia, totale)
			// dal file somministrazioni-vaccini-latest.csv
		// successivamente ordino le entry per area, fascia e data
	...
	public static Date getFilterDate( ) {
		// prendo in considerazione solo istanze di date a partire da febbraio 2021
